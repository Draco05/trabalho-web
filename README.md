# ReceitaFácil
## Trabalho de Introdução ao Desenvolvimento Web - SCC0219

## Descrição
Muitas vezes, não temos comida suficiente em casa para preparar a refeição que desejamos e não queremos sair para comprar mais. Ou, ainda, temos muitos alimentos que estão prestes a vencer, mas que nós não sabemos como utilizar para preparar algo com o que possuímos.
...
## Integrantes do grupo:
    ...
    Pedro Henrique Barbosa Oliveira         N°USP: 15483776
